...
#+BEGIN_SRC emacs-lisp
(setq custom-file (expand-file-name "custom" gmacs-emacs-dir))
(load custom-file)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(setq savehist-file (expand-file-name "cache/savehist" gmacs-emacs-dir))
(savehist-mode 1)
...
*** Proselinting
Check prose style.
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref proseling
...
(use-package web-mode
  :config (add-to-list 'auto-mode-alist '("\\.scss\\'" . web-mode))
  :custom
...
**** Cleverref
#+BEGIN_SRC emacs-lisp
(defun org-latex-ref-to-cref (text backend)
