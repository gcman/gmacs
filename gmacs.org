...
(use-package flyspell
  ...
  :init
  (when gm/spelling (add-hook 'org-mode-hook #'flyspell-mode))
  (after! notmuch
...
Not too small.
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref org-settings
(when gm/latex (setq org-format-latex-options (plist-put org-format-latex-options :scale 2.75)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(when gm/latex (setq org-latex-default-class "gm-notes"))
#+END_SRC
* Media
