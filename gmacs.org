...
#+BEGIN_SRC emacs-lisp :noweb-ref pack-init
...
(defun gm/package-initialize ()
  <<pack-init>>)

(eval-when-compile <<pack-init>>)
#+END_SRC
...
This allows packages to be installed on the fly.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
(use-package bratex
  :straight (:host github :repo "sbrisard/bratex")
  :commands (bratex-config))
(add-hook 'quick-math-mode-hook #'bratex-config)
#+END_SRC
*** Export
#+BEGIN_SRC emacs-lisp
(use-package ox-tufte-latex
  :straight (:host github :repo "tsdye/tufte-org-mode")
  :commands (org-tufte-latex-export-to-latex))
