...
(setq auto-save-file-name-transforms '((".*"  "cache/auto-save-list/" t)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(setq savehist-file (expand-file-name "savehist" gmacs-cache-dir)
      save-place-file (expand-file-name "saveplaces" gmacs-cache-dir)
      recentf-save-file (expand-file-name "recentf" gmacs-cache-dir)
      transiient-history-file (expand-file-name "transient-history.el" gmacs-cache-dir)
