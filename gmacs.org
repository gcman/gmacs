...
locally used dictionary to Canadian English, and we set up the liscbt of valid
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref dired-keys
(use-package dired-du
  :commands (dired-du-mode))
(bind-key "C-x M-r" #'dired-du-mode dired-mode-map)
#+END_SRC
...
(bind-key "M-j" #'bjm/ivy-yank-whole-word ivy-minibuffer-map)
#+END_SRC
*** God Mode
...
#+END_SRC
I've never used this command on purpose.
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref org-settings
(unbind-key "C-c [")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :noweb yes
(use-package org-ref
  :commands (org-ref-bibtex-new-entry/body)
  :config
  (require 'doi-utils)
...
(org-ref-bibliography-notes (expand-file-name "ref/notes.org" org-directory))
(org-ref-default-bibliography (expand-file-name "ref/references.bib" org-directory))
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref org-ref
(orhc-bibtex-cache-file (expand-file-name ".orhc-bibtex-cache" gmacs-cache-dir))
#+END_SRC
Small modification to how files are attached to bib entries. I want the default
