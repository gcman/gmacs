...
(set-fontset-font "fontset-default" '(#x2200 . #x22ff) "Symbola")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(set-fontset-font "fontset-default" '(#x211c . #x211c) "Symbola") ;; real part ℜ
(set-fontset-font "fontset-default" '(#x2111 . #x2111) "Symbola") ;; imaginary part ℑ
(set-fontset-font "fontset-default" '(#x2113 . #x2113) "Symbola") ;; ell ℓ
(set-fontset-font "fontset-default" '(#x2118 . #x2118) "Symbola") ;; Weierstrass p ℘
(set-fontset-font "fontset-default" '(#x2135 . #x2135) "Symbola") ;; aleph ℵ
#+END_SRC
**** Syntax Highlighting
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb-ref elfeed-settings
(run-at-time 10 (* 60 30) 'elfeed-update)
#+END_SRC
  ...
  (cond
   ...
   ((string-match "[\])]" (char-to-string (char-before)))
    (let ((end (point))
      ...
      (gm/math-insert-frac-match match "quotient")))
