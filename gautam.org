...
(define-conditional-key org-mode-map "2" (gm/math-subscript) (texmathp))
(define-conditional-key org-mode-map "3" (gm/math-subscript) (texmathp))
(define-conditional-key org-mode-map "4" (gm/math-subscript) (texmathp))
(define-conditional-key org-mode-map "5" (gm/math-subscript) (texmathp))
(define-conditional-key org-mode-map "6" (gm/math-subscript) (texmathp))
(define-conditional-key org-mode-map "7" (gm/math-subscript) (texmathp))
(define-conditional-key org-mode-map "8" (gm/math-subscript) (texmathp))
