...
(defvar bjm/auto-save-interval 60
...
(use-package pdf-tools
  ...
  :config
  (pdf-tools-install)
  (setq-default pdf-view-midnight-colours '("#657b83" . "#fdf6e3"))
...
#+END_SRC
**** Justify
Obtained from [[http://kitchingroup.cheme.cmu.edu/blog/2016/11/06/Justifying-LaTeX-preview-fragments-in-org-mode/][Justifying LaTeX preview fragments in org-mode]].
#+BEGIN_SRC emacs-lisp
...
line are justified."
  (cond
   ((and (= beg (line-beginning-position))
         (string-match "equation" (buffer-substring-no-properties beg end))))
...
(define-key org-mode-map (kbd "s") 'hydra-s/body)
...
(define-key org-mode-map (kbd "c") 'hydra-c/body)
#+END_SRC
*** Derivative
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "d") 'hydra-d/body)
#+END_SRC
...
(define-key org-mode-map (kbd "r") 'hydra-r/body)
#+END_SRC
*** Inverse, Integral, In
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "n") 'hydra-n/body)
#+END_SRC
*** Maps To
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "!") 'hydra-exc/body)
#+END_SRC
*** Implies
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "=") 'hydra-eq/body)
#+END_SRC
*** Limit, Sin
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "i") 'hydra-i/body)
#+END_SRC
*** Sum
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "u") 'hydra-u/body)
#+END_SRC
*** Less Than
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "l") 'hydra-l/body)
#+END_SRC
*** Greater Than
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "g") 'hydra-g/body)
#+END_SRC
*** Pairsum
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "p") 'hydra-p/body)
#+END_SRC
*** Set, Sec
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "e") 'hydra-e/body)
#+END_SRC
*** Times
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "x") 'hydra-x/body)
#+END_SRC
...
(define-key org-mode-map (kbd "o") 'hydra-o/body)
#+END_SRC
*** Tan, Arctan
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "a") 'hydra-a/body)
#+END_SRC
*** Fraction, Floor
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "f") 'hydra-f/body)
#+END_SRC
...
(define-key org-mode-map (kbd "b") 'hydra-b/body)
#+END_SRC
*** Number Systems
**** Real
#+BEGIN_SRC emacs-lisp
...
(define-key org-mode-map (kbd "Q") 'hydra-Q/body)
#+END_SRC
**** Complex
#+BEGIN_SRC emacs-lisp
(defhydra hydra-C (:color blue
...
(define-key org-mode-map (kbd "Z") 'hydra-Z/body)
#+END_SRC
**** Natural
#+BEGIN_SRC emacs-lisp
(defhydra hydra-N (:color blue
...
(define-key org-mode-map (kbd "M") 'hydra-M/body)
#+END_SRC
*** Math Symbols
#+BEGIN_SRC emacs-lisp
