...
("q" (if (texmathp) (progn
       (delete-char -1)
       (yas-expand-snippet
       (yas-lookup-snippet "sqrt"))) (insert "q")) "auto-expand 'sqrt'"))
...
("b" (if (texmathp) (progn
       (delete-char -1)
       (if (= (char-before (- (point) 1)) ? ) (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "cubed"))) (insert "b")) "auto-expand 'cubed'")
("c" (if (texmathp) (progn
       (delete-char -1)
       (yas-expand-snippet
       (yas-lookup-snippet "subset"))) (insert "c")) "auto-expand 'subset'"))
...
("d" (if (texmathp) (progn
       (delete-char -1)
       (yas-expand-snippet
       (yas-lookup-snippet "derivative"))) (insert "d")) "auto-expand 'derivative'"))
...
(defhydra hydra-r (:color blue
                         :body-pre (insert "r")
                         :idle 1.0)
("t" (if (and (texmathp) (= (char-before (- (point) 1)) ?a) (= (char-before (- (point) 2)) ?p))
       (progn
       (dotimes (i 3)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "partial"))) (insert "t")) "auto-expand 'partial'")
("9" (if (and (texmathp) (= (char-before (- (point) 1)) ?l))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "parentheses"))) (insert "9")) "auto-expand 'parentheses'")
("[" (if (and (texmathp) (= (char-before (- (point) 1)) ?l))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "brackets"))) (insert "")) "auto-expand 'brackets'")
("{" (if (and (texmathp) (= (char-before (- (point) 1)) ?l))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "set"))) (insert "")) "auto-expand 'set'"))
...
(defhydra hydra-n (:color blue
                         :body-pre (insert "n")
                         :idle 1.0)
("v" (if (and (texmathp) (= (char-before (- (point) 1)) ?i))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "inverse"))) (insert "v")) "auto-expand 'inverse'")
("t" (if (and (texmathp) (= (char-before (- (point) 1)) ?i))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "integral"))) (insert "t")) "auto-expand 'integral'")
("n" (if (and (texmathp) (= (char-before (- (point) 1)) ?i))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "inn"))) (insert "n")) "auto-expand 'in'"))
...
(">" (if (texmathp) (progn
       (delete-char -1)
       (yas-expand-snippet
       (yas-lookup-snippet "maps-to"))) (insert ">")) "auto-expand 'maps-to'"))

 (add-hook 'LaTeX-mode-hook
     (lambda ()
     (local-set-key (kbd "!") 'hydra-exc/body)))
#+END_SRC
*** Implies
#+BEGIN_SRC emacs-lisp
...
(">" (if (texmathp) (progn
       (delete-char -1)
       (yas-expand-snippet
       (yas-lookup-snippet "implies"))) (insert ">")) "auto-expand 'implies'"))
...
(defhydra hydra-i (:color blue
                         :body-pre (insert "i")
                         :idle 1.0)
("m" (if (and (texmathp) (= (char-before (- (point) 1)) ?l))
       (progn
       (dotimes (i 2) (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "limit"))) (insert "m")) "auto-expand 'limit'")
("n" (if (and (texmathp) (= (char-before (- (point) 1)) ?s))
       (if (= (char-before (- (point) 2)) ?a)
         (progn
         (dotimes (i 3) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "asin")))
         (progn
         (dotimes (i 2) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "sin"))))
         (hydra-n/body)) "auto-expand '(a)sin'"))
...
(defhydra hydra-u (:color blue
                         :body-pre (insert "u")
                         :idle 1.0)
("m" (if (and (texmathp) (= (char-before (- (point) 1)) ?s))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "summation"))) (insert "m")) "auto-expand 'sum'"))
...
(defhydra hydra-e (:color blue
                         :body-pre (insert "e")
                         :idle 1.0)
("t" (if (and (texmathp) (= (char-before (- (point) 1)) ?s))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "set"))) (insert "t")) "auto-expand 'set'")
("c" (if (and (texmathp) (= (char-before (- (point) 1)) ?s))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "sec"))) (insert "c")) "auto-expand 'sec'"))
...
(defhydra hydra-o (:color blue
                         :body-pre (insert "o")
                         :idle 1.0)
("g" (if (and (texmathp) (= (char-before (- (point) 1)) ?l))
       (progn
       (dotimes (i 2)
         (delete-char -1))
       (yas-expand-snippet
       (yas-lookup-snippet "log"))) (insert "g")) "auto-expand 'log'")
("s" (if (and (texmathp) (= (char-before (- (point) 1)) ?c))
       (if (= (char-before (- (point) 2)) ?a)
         (progn
         (dotimes (i 3) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "acos")))
         (progn
         (dotimes (i 2) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "cos"))))
       (insert "s")) "auto-expand '(a)cos'")
("t" (if (and (texmathp) (= (char-before (- (point) 1)) ?c))
       (if (= (char-before (- (point) 2)) ?a)
         (progn
         (dotimes (i 3) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "acot")))
         (progn
         (dotimes (i 2) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "cot"))))
       (insert "t")) "auto-expand '(a)cot'"))
...
(defhydra hydra-a (:color blue
                         :body-pre (insert "a")
                         :idle 1.0)
("n" (if (and (texmathp) (= (char-before (- (point) 1)) ?t))
       (if (= (char-before (- (point) 2)) ?a)
         (progn
         (dotimes (i 3) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "atan")))
         (progn
         (dotimes (i 2) (delete-char -1))
         (yas-expand-snippet (yas-lookup-snippet "tan"))))
       (insert "n")) "auto-expand '(a)tan'"))
 (add-hook 'LaTeX-mode-hook
     (lambda ()
...
("r" (if (texmathp) (progn
       (delete-char -1)
       (yas-expand-snippet
       (yas-lookup-snippet "frac"))) (insert "r")) "auto-expand 'frac'"))
